...
use com\microsoft\wc\thing\CultureSpecificString;
...
class CultureSpecificExtensionItem {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Stringnz", name="name")
	 */
	protected $name;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\CultureSpecificString", collection="true", name="value")
	 */
	protected $value;
