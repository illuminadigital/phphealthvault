...
use com\microsoft\wc\thing\CultureSpecificExtensionItem;
...
class CultureSpecificExtensionItems {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\CultureSpecificExtensionItem", collection="true", name="extension-item")
	 */
