...
use com\microsoft\wc\thing\DigestMethod;
...
class ReferenceType {
	...
	protected function validateDigestMethod($digestMethod) {
		if ( ! $digestMethod instanceof DigestMethod ) {
			$digestMethod = new DigestMethod ($digestMethod);
		}
	...
	protected function validateDigestValue($digestValue) {
		if ( ! $digestValue instanceof DigestValue ) {
