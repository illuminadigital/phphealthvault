...
use com\microsoft\wc\thing\CanonicalizationMethod;
use com\microsoft\wc\thing\SignatureMethod;
...
class SignedInfoType {
	...
	protected function validateCanonicalizationMethod($canonicalizationMethod) {
		if ( ! $canonicalizationMethod instanceof CanonicalizationMethod ) {
			$canonicalizationMethod = new CanonicalizationMethod ($canonicalizationMethod);
		}
	...
	protected function validateSignatureMethod($signatureMethod) {
		if ( ! $signatureMethod instanceof SignatureMethod ) {
			$signatureMethod = new SignatureMethod ($signatureMethod);
		}
