...
class OpenQueryInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Guid", name="query-id")
	 */
	protected $queryId;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\String255", name="app-name")
	 */
	protected $appName;
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\String128", name="note")
	 */
	protected $note;
