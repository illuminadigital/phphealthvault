...
use com\microsoft\wc\thing\String255;
use com\microsoft\wc\thing\AppSettings;
use com\microsoft\wc\thing\Groups;
use com\microsoft\wc\thing\Culture;
use com\microsoft\wc\thing\Location;
...
class PersonInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Guid", name="person-id")
	 */
	protected $personId;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\String255", name="name")
	 */
	protected $name;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\AppSettings", name="app-settings")
	 */
	protected $appSettings;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Guid", name="selected-record-id")
	 */
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Record", collection="true", name="record")
	 */
	protected $record;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Groups", name="groups")
	 */
	protected $groups;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Culture", name="preferred-culture")
	 */
	protected $preferredCulture;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Culture", name="preferred-uiculture")
	 */
	protected $preferredUiculture;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Location", name="location")
	 */
	protected $location;
