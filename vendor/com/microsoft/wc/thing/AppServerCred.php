...
use com\microsoft\wc\thing\Sig;
use com\microsoft\wc\thing\AppServerCredInfo;
...
class AppServerCred {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Sig", name="sig")
	 */
	protected $sig;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\AppServerCredInfo", name="content")
	 */
	protected $content;
