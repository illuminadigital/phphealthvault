...
class OpenQueryInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Guid", name="query-id")
	 */
	protected $queryId;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\String255", name="app-name")
	 */
	protected $appName;
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\String128", name="note")
	 */
	protected $note;
