...
use com\microsoft\wc\application\DateRange;
...
class Set {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\DateRange", collection="true", name="date-range")
	 */
	protected $dateRange;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Guid", collection="true", name="type-id")
	 */
	protected $typeId;
