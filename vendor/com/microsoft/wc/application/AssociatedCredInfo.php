...
use com\microsoft\wc\application\SimpleOpenIdCredential;
use com\microsoft\wc\application\SimpleFacebookCredential;
use com\microsoft\wc\application\SimpleEmergencyAccessCredential;
use com\microsoft\wc\application\SimplePhoneFactorCredential;
use com\microsoft\wc\application\IntegratedWindowsCredential;
use com\microsoft\wc\application\String64;
...
class AssociatedCredInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Stringnz", name="simple-encrypted")
	 */
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\SimpleOpenIdCredential", name="simple-openid")
	 */
	protected $simpleOpenid;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\SimpleFacebookCredential", name="simple-facebook")
	 */
	protected $simpleFacebook;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\SimpleEmergencyAccessCredential", name="simple-emergency-access")
	 */
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\IntegratedWindowsCredential", name="integrated-windows")
	 */
	protected $integratedWindows;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Stringnz", name="credential-metadata")
	 */
	protected $credentialMetadata;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\String64", name="credential-name")
	 */
