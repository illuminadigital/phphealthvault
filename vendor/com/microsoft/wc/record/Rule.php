...
use com\microsoft\wc\record\Set;
...
class Rule {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\record\Set", collection="true", name="target-set")
	 */
	protected $targetSet;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\record\Set", collection="true", name="exception-set")
	 */
