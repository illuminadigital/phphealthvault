...
use com\microsoft\wc\record\TextualPermissionsType;
use com\microsoft\wc\record\TextualRule;
...
class TextualPermissions {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\record\TextualPermissionsType", name="textual-permissions-type")
	 */
	protected $textualPermissionsType;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\record\TextualRule", name="textual-rule")
	 */
