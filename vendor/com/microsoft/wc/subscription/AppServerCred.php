...
use com\microsoft\wc\subscription\Sig;
use com\microsoft\wc\subscription\AppServerCredInfo;
...
class AppServerCred {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Sig", name="sig")
	 */
	protected $sig;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\AppServerCredInfo", name="content")
	 */
	protected $content;
