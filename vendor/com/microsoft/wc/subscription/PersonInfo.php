...
use com\microsoft\wc\subscription\String255;
use com\microsoft\wc\subscription\AppSettings;
use com\microsoft\wc\subscription\Groups;
use com\microsoft\wc\subscription\Culture;
use com\microsoft\wc\subscription\Location;
use com\microsoft\wc\subscription\Record;
...
class PersonInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Guid", name="person-id")
	 */
	protected $personId;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\String255", name="name")
	 */
	protected $name;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\AppSettings", name="app-settings")
	 */
	protected $appSettings;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Guid", name="selected-record-id")
	 */
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Record", collection="true", name="record")
	 */
	protected $record;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Groups", name="groups")
	 */
	protected $groups;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Culture", name="preferred-culture")
	 */
	protected $preferredCulture;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Culture", name="preferred-uiculture")
	 */
	protected $preferredUiculture;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Location", name="location")
	 */
	protected $location;
