...
use com\microsoft\wc\subscription\CultureSpecificExtensionItem;
...
class CultureSpecificExtensionItems {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\CultureSpecificExtensionItem", collection="true", name="extension-item")
	 */
