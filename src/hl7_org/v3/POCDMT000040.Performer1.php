 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Performer1")
 */
class POCDMT000040.Performer1 {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $functionCode = NULL, $time = NULL, $assignedEntity = NULL, $nullFlavor = NULL, $typeCode = NULL) {
...
} // end class POCDMT000040.Performer1
