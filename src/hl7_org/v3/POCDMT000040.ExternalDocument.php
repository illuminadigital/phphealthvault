...
class POCDMT000040.ExternalDocument {
	...
	protected function createClassCode() {
		return new \hl7_org\v3\ActClassDocument();
	}
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\ActClassDocument  && ! is_null($classCode) ) {
			$classCode = new \hl7_org\v3\ActClassDocument ($classCode);
		}
