 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.EncounterParticipant")
 */
class POCDMT000040.EncounterParticipant {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $time = NULL, $assignedEntity = NULL, $nullFlavor = NULL, $typeCode = NULL) {
...
} // end class POCDMT000040.EncounterParticipant
