 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.LegalAuthenticator")
 */
class POCDMT000040.LegalAuthenticator {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $time = NULL, $signatureCode = NULL, $assignedEntity = NULL, $nullFlavor = NULL, $typeCode = NULL, $contextControlCode = NULL) {
	...
	public function getSignatureCode($autoCreate = TRUE) {
		if ($this->signatureCode===NULL && $autoCreate && ! isset($this->_overrides['signatureCode']) ) {
...
} // end class POCDMT000040.LegalAuthenticator
