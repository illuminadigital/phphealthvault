...
class POCDMT000040.Consumable {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.ManufacturedProduct", name="manufacturedProduct")
	 */
	...
	public function getManufacturedProduct($autoCreate = TRUE) {
		if ($this->manufacturedProduct===NULL && $autoCreate && ! isset($this->_overrides['manufacturedProduct']) ) {
