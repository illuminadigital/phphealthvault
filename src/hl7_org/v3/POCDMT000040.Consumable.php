 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Consumable")
 */
class POCDMT000040.Consumable {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.ManufacturedProduct", name="manufacturedProduct")
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $manufacturedProduct = NULL, $nullFlavor = NULL, $typeCode = NULL) {
		$this->realmCode = ($realmCode===NULL) ? NULL : $this->validateRealmCode($realmCode);
		$this->typeId = ($typeId===NULL) ? NULL : $this->validateTypeId($typeId);
		$this->templateId = ($templateId===NULL) ? NULL : $this->validateTemplateId($templateId);
		$this->manufacturedProduct = ($manufacturedProduct===NULL) ? NULL : $this->validateManufacturedProduct($manufacturedProduct);
	...
	public function getManufacturedProduct() {
		if ($this->manufacturedProduct===NULL) {
			$this->manufacturedProduct = $this->createManufacturedProduct();
		}
		return $this->manufacturedProduct;
	}
	
	protected function createManufacturedProduct() {
		return new \hl7_org\v3\POCDMT000040.ManufacturedProduct();
	}

	public function setManufacturedProduct($manufacturedProduct) {
		$this->manufacturedProduct = $this->validateManufacturedProduct($manufacturedProduct);
	}

	protected function validateManufacturedProduct($manufacturedProduct) {
		if ( ! $manufacturedProduct instanceof \hl7_org\v3\POCDMT000040.ManufacturedProduct ) {
			$manufacturedProduct = new \hl7_org\v3\POCDMT000040.ManufacturedProduct ($manufacturedProduct);
		}
...
} // end class POCDMT000040.Consumable
