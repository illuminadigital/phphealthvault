 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Authorization")
 */
class POCDMT000040.Authorization {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Consent", name="consent")
	 */
	protected $consent;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $consent = NULL, $nullFlavor = NULL, $typeCode = NULL) {
	...
	protected function createConsent() {
		return new \hl7_org\v3\POCDMT000040.Consent();
	}
	...
	protected function validateConsent($consent) {
		if ( ! $consent instanceof \hl7_org\v3\POCDMT000040.Consent ) {
			$consent = new \hl7_org\v3\POCDMT000040.Consent ($consent);
		}
...
} // end class POCDMT000040.Authorization
