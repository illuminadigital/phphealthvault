...
class POCDMT000040.Material {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\ST", name="lotNumberText")
	 */
	...
	public function getLotNumberText($autoCreate = TRUE) {
		if ($this->lotNumberText===NULL && $autoCreate && ! isset($this->_overrides['lotNumberText']) ) {
