...
class POCDMT000040.Precondition {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.Criterion", name="criterion")
	 */
	protected $criterion;
	...
	public function getCriterion($autoCreate = TRUE) {
		if ($this->criterion===NULL && $autoCreate && ! isset($this->_overrides['criterion']) ) {
