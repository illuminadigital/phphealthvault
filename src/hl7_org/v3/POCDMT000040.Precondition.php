 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Precondition")
 */
class POCDMT000040.Precondition {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Criterion", name="criterion")
	 */
	protected $criterion;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $criterion = NULL, $nullFlavor = NULL, $typeCode = NULL) {
		$this->realmCode = ($realmCode===NULL) ? NULL : $this->validateRealmCode($realmCode);
		$this->typeId = ($typeId===NULL) ? NULL : $this->validateTypeId($typeId);
		$this->templateId = ($templateId===NULL) ? NULL : $this->validateTemplateId($templateId);
		$this->criterion = ($criterion===NULL) ? NULL : $this->validateCriterion($criterion);
	...
	public function getCriterion() {
		if ($this->criterion===NULL) {
			$this->criterion = $this->createCriterion();
		}
		return $this->criterion;
	}
	
	protected function createCriterion() {
		return new \hl7_org\v3\POCDMT000040.Criterion();
	}

	public function setCriterion($criterion) {
		$this->criterion = $this->validateCriterion($criterion);
	}

	protected function validateCriterion($criterion) {
		if ( ! $criterion instanceof \hl7_org\v3\POCDMT000040.Criterion ) {
			$criterion = new \hl7_org\v3\POCDMT000040.Criterion ($criterion);
		}
...
} // end class POCDMT000040.Precondition
