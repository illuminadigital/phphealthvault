 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Criterion")
 */
class POCDMT000040.Criterion {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $code = NULL, $text = NULL, $value = NULL, $nullFlavor = NULL, $classCode = NULL, $moodCode = NULL) {
...
} // end class POCDMT000040.Criterion
