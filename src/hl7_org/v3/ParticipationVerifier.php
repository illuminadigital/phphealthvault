 ...
 * })
 * @XmlRootEntity	(xml="ParticipationVerifier")
 */
class ParticipationVerifier {
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'ParticipationVerifier', $value));
		}
...
} // end class ParticipationVerifier
