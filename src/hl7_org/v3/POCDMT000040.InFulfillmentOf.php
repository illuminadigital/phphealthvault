 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.InFulfillmentOf")
 */
class POCDMT000040.InFulfillmentOf {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Order", name="order")
	 */
	protected $order;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $order = NULL, $nullFlavor = NULL, $typeCode = NULL) {
		$this->realmCode = ($realmCode===NULL) ? NULL : $this->validateRealmCode($realmCode);
		$this->typeId = ($typeId===NULL) ? NULL : $this->validateTypeId($typeId);
		$this->templateId = ($templateId===NULL) ? NULL : $this->validateTemplateId($templateId);
		$this->order = ($order===NULL) ? NULL : $this->validateOrder($order);
	...
	protected function createOrder() {
		return new \hl7_org\v3\POCDMT000040.Order();
	}
	...
	protected function validateOrder($order) {
		if ( ! $order instanceof \hl7_org\v3\POCDMT000040.Order ) {
			$order = new \hl7_org\v3\POCDMT000040.Order ($order);
		}
	...
	protected function createTypeCode() {
		return new \hl7_org\v3\ActRelationshipFulfills();
	}
	...
	protected function validateTypeCode($typeCode) {
		if ( ! $typeCode instanceof \hl7_org\v3\ActRelationshipFulfills  && ! is_null($typeCode) ) {
			$typeCode = new \hl7_org\v3\ActRelationshipFulfills ($typeCode);
		}
	
		return $typeCode;
	}
} // end class POCDMT000040.InFulfillmentOf
