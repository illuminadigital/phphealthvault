...
class POCDMT000040.HealthCareFacility {
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Place", name="location")
	 */
	protected $location;

	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Organization", name="serviceProviderOrganization")
	 */
	...
	protected function validateLocation($location) {
		if ( ! $location instanceof \hl7_org\v3\POCDMT000040.Place  && ! is_null($location) ) {
			$location = new \hl7_org\v3\POCDMT000040.Place ($location);
		}
	
		return $location;
	}

	public function getServiceProviderOrganization() {
		if ($this->serviceProviderOrganization===NULL) {
	...
	protected function validateServiceProviderOrganization($serviceProviderOrganization) {
		if ( ! $serviceProviderOrganization instanceof \hl7_org\v3\POCDMT000040.Organization  && ! is_null($serviceProviderOrganization) ) {
			$serviceProviderOrganization = new \hl7_org\v3\POCDMT000040.Organization ($serviceProviderOrganization);
		}
	...
	protected function createClassCode() {
		return new \hl7_org\v3\RoleClassServiceDeliveryLocation();
	}
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\RoleClassServiceDeliveryLocation  && ! is_null($classCode) ) {
			$classCode = new \hl7_org\v3\RoleClassServiceDeliveryLocation ($classCode);
		}
