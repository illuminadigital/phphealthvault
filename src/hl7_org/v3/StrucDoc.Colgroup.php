 ...
 * })
 * @XmlEntity	(xml="StrucDoc.Colgroup")
 */
class StrucDoc.Colgroup {
	/**
	 */
	...
	public function __construct($col = NULL, $iD = NULL, $language = NULL, $styleCode = NULL, $span = NULL, $width = NULL, $align = NULL, $char = NULL, $charoff = NULL, $valign = NULL) {
