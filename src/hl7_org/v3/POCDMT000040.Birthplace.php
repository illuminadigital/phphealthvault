...
class POCDMT000040.Birthplace {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.Place", name="place")
	 */
	protected $place;
	...
	public function getPlace($autoCreate = TRUE) {
		if ($this->place===NULL && $autoCreate && ! isset($this->_overrides['place']) ) {
