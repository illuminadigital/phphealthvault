...
class POCDMT000040.Component1 {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.EncompassingEncounter", name="encompassingEncounter")
	 */
	...
	public function getEncompassingEncounter($autoCreate = TRUE) {
		if ($this->encompassingEncounter===NULL && $autoCreate && ! isset($this->_overrides['encompassingEncounter']) ) {
