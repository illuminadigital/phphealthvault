 ...
 * })
 * @XmlRootEntity	(xml="ParticipationAncillary")
 */
class ParticipationAncillary {
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'ParticipationAncillary', $value));
		}
...
} // end class ParticipationAncillary
