...
class POCDMT000040.Procedure {
	...
	protected function createMoodCode() {
		return new \hl7_org\v3\XDocumentProcedureMood();
	}
	...
	protected function validateMoodCode($moodCode) {
		if ( ! $moodCode instanceof \hl7_org\v3\XDocumentProcedureMood ) {
			$moodCode = new \hl7_org\v3\XDocumentProcedureMood ($moodCode);
		}
