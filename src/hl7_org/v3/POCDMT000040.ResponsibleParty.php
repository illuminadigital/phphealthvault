 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.ResponsibleParty")
 */
class POCDMT000040.ResponsibleParty {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $assignedEntity = NULL, $nullFlavor = NULL, $typeCode = NULL) {
...
} // end class POCDMT000040.ResponsibleParty
