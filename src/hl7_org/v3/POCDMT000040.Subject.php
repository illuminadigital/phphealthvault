...
class POCDMT000040.Subject {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\CE", name="awarenessCode")
	 */
	protected $awarenessCode;

	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.RelatedSubject", name="relatedSubject")
	 */
	...
	public function getRelatedSubject($autoCreate = TRUE) {
		if ($this->relatedSubject===NULL && $autoCreate && ! isset($this->_overrides['relatedSubject']) ) {
