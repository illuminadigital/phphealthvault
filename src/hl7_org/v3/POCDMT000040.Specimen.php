 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Specimen")
 */
class POCDMT000040.Specimen {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.SpecimenRole", name="specimenRole")
	 */
	protected $specimenRole;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $specimenRole = NULL, $nullFlavor = NULL, $typeCode = NULL) {
		$this->realmCode = ($realmCode===NULL) ? NULL : $this->validateRealmCode($realmCode);
		$this->typeId = ($typeId===NULL) ? NULL : $this->validateTypeId($typeId);
		$this->templateId = ($templateId===NULL) ? NULL : $this->validateTemplateId($templateId);
		$this->specimenRole = ($specimenRole===NULL) ? NULL : $this->validateSpecimenRole($specimenRole);
	...
	public function getSpecimenRole() {
		if ($this->specimenRole===NULL) {
			$this->specimenRole = $this->createSpecimenRole();
		}
		return $this->specimenRole;
	}
	
	protected function createSpecimenRole() {
		return new \hl7_org\v3\POCDMT000040.SpecimenRole();
	}

	public function setSpecimenRole($specimenRole) {
		$this->specimenRole = $this->validateSpecimenRole($specimenRole);
	}

	protected function validateSpecimenRole($specimenRole) {
		if ( ! $specimenRole instanceof \hl7_org\v3\POCDMT000040.SpecimenRole ) {
			$specimenRole = new \hl7_org\v3\POCDMT000040.SpecimenRole ($specimenRole);
		}
...
} // end class POCDMT000040.Specimen
