...
class POCDMT000040.Specimen {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.SpecimenRole", name="specimenRole")
	 */
	...
	public function getSpecimenRole($autoCreate = TRUE) {
		if ($this->specimenRole===NULL && $autoCreate && ! isset($this->_overrides['specimenRole']) ) {
