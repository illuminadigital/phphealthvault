...
class POCDMT000040.InformationRecipient {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.IntendedRecipient", name="intendedRecipient")
	 */
	...
	public function getIntendedRecipient($autoCreate = TRUE) {
		if ($this->intendedRecipient===NULL && $autoCreate && ! isset($this->_overrides['intendedRecipient']) ) {
