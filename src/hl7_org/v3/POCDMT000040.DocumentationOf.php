...
class POCDMT000040.DocumentationOf {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.ServiceEvent", name="serviceEvent")
	 */
	...
	public function getServiceEvent($autoCreate = TRUE) {
		if ($this->serviceEvent===NULL && $autoCreate && ! isset($this->_overrides['serviceEvent']) ) {
