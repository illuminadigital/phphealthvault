 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.AssociatedEntity")
 */
class POCDMT000040.AssociatedEntity {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Person", name="associatedPerson")
	 */
	protected $associatedPerson;

	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Organization", name="scopingOrganization")
	 */
	protected $scopingOrganization;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $id = NULL, $code = NULL, $addr = NULL, $telecom = NULL, $associatedPerson = NULL, $scopingOrganization = NULL, $nullFlavor = NULL, $classCode = NULL) {
		...
		$this->associatedPerson = ($associatedPerson===NULL) ? NULL : $this->validateAssociatedPerson($associatedPerson);
		$this->scopingOrganization = ($scopingOrganization===NULL) ? NULL : $this->validateScopingOrganization($scopingOrganization);
	...
	public function getAssociatedPerson() {
		if ($this->associatedPerson===NULL) {
			$this->associatedPerson = $this->createAssociatedPerson();
		}
		return $this->associatedPerson;
	}
	
	protected function createAssociatedPerson() {
		return new \hl7_org\v3\POCDMT000040.Person();
	}

	public function setAssociatedPerson($associatedPerson) {
		$this->associatedPerson = $this->validateAssociatedPerson($associatedPerson);
	}

	protected function validateAssociatedPerson($associatedPerson) {
		if ( ! $associatedPerson instanceof \hl7_org\v3\POCDMT000040.Person  && ! is_null($associatedPerson) ) {
			$associatedPerson = new \hl7_org\v3\POCDMT000040.Person ($associatedPerson);
		}
	
		return $associatedPerson;
	}

	public function getScopingOrganization() {
		if ($this->scopingOrganization===NULL) {
			$this->scopingOrganization = $this->createScopingOrganization();
		}
		return $this->scopingOrganization;
	}
	
	protected function createScopingOrganization() {
		return new \hl7_org\v3\POCDMT000040.Organization();
	}

	public function setScopingOrganization($scopingOrganization) {
		$this->scopingOrganization = $this->validateScopingOrganization($scopingOrganization);
	}

	protected function validateScopingOrganization($scopingOrganization) {
		if ( ! $scopingOrganization instanceof \hl7_org\v3\POCDMT000040.Organization  && ! is_null($scopingOrganization) ) {
			$scopingOrganization = new \hl7_org\v3\POCDMT000040.Organization ($scopingOrganization);
		}
	...
	protected function createClassCode() {
		return new \hl7_org\v3\RoleClassAssociative();
	}
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\RoleClassAssociative ) {
			$classCode = new \hl7_org\v3\RoleClassAssociative ($classCode);
		}
	
		return $classCode;
	}
} // end class POCDMT000040.AssociatedEntity
