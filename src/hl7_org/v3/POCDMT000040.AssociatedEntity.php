...
class POCDMT000040.AssociatedEntity {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.Person", name="associatedPerson")
	 */
	protected $associatedPerson;

	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.Organization", name="scopingOrganization")
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $id = NULL, $code = NULL, $addr = NULL, $telecom = NULL, $associatedPerson = NULL, $scopingOrganization = NULL, $patient = NULL, $nullFlavor = NULL, $classCode = NULL) {
	...
	public function getAssociatedPerson($autoCreate = TRUE) {
		if ($this->associatedPerson===NULL && $autoCreate && ! isset($this->_overrides['associatedPerson']) ) {
	...
	public function getScopingOrganization($autoCreate = TRUE) {
		if ($this->scopingOrganization===NULL && $autoCreate && ! isset($this->_overrides['scopingOrganization']) ) {
