 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.LabeledDrug")
 */
class POCDMT000040.LabeledDrug {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $code = NULL, $name = NULL, $nullFlavor = NULL, $classCode = NULL, $determinerCode = NULL) {
...
} // end class POCDMT000040.LabeledDrug
