...
class POCDMT000040.RelatedDocument {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.ParentDocument", name="parentDocument")
	 */
	...
	public function getParentDocument($autoCreate = TRUE) {
		if ($this->parentDocument===NULL && $autoCreate && ! isset($this->_overrides['parentDocument']) ) {
