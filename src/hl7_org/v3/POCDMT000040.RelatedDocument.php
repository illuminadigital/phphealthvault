...
class POCDMT000040.RelatedDocument {
	...
	protected function createTypeCode() {
		return new \hl7_org\v3\XActRelationshipDocument();
	}
	...
	protected function validateTypeCode($typeCode) {
		if ( ! $typeCode instanceof \hl7_org\v3\XActRelationshipDocument ) {
			$typeCode = new \hl7_org\v3\XActRelationshipDocument ($typeCode);
		}
