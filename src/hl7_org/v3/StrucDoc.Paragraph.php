 ...
 * })
 * @XmlEntity	(xml="StrucDoc.Paragraph")
 */
class StrucDoc.Paragraph {
	/**
	 */
	...
	public function __construct($caption = NULL, $content = NULL, $linkHtml = NULL, $sub = NULL, $sup = NULL, $br = NULL, $footnote = NULL, $footnoteRef = NULL, $renderMultiMedia = NULL, $iD = NULL, $language = NULL, $styleCode = NULL) {
