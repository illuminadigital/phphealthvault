...
class POCDMT000040.Location {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.HealthCareFacility", name="healthCareFacility")
	 */
	...
	public function getHealthCareFacility($autoCreate = TRUE) {
		if ($this->healthCareFacility===NULL && $autoCreate && ! isset($this->_overrides['healthCareFacility']) ) {
