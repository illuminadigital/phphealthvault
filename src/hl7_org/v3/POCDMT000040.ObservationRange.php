 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.ObservationRange")
 */
class POCDMT000040.ObservationRange {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\ANY", name="value")
	 */
	protected $value;

	/**
	 * @XmlElement	(type="\hl7_org\v3\CE", name="interpretationCode")
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $code = NULL, $text = NULL, $value = NULL, $interpretationCode = NULL, $nullFlavor = NULL, $classCode = NULL, $moodCode = NULL) {
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\ActClassObservation  && ! is_null($classCode) ) {
...
} // end class POCDMT000040.ObservationRange
