 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Performer2")
 */
class POCDMT000040.Performer2 {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $time = NULL, $modeCode = NULL, $assignedEntity = NULL, $nullFlavor = NULL, $typeCode = NULL) {
	...
	protected function createTypeCode() {
		return new \hl7_org\v3\ParticipationPhysicalPerformer();
	}
	...
	protected function validateTypeCode($typeCode) {
		if ( ! $typeCode instanceof \hl7_org\v3\ParticipationPhysicalPerformer  && ! is_null($typeCode) ) {
			$typeCode = new \hl7_org\v3\ParticipationPhysicalPerformer ($typeCode);
		}
	
		return $typeCode;
	}
} // end class POCDMT000040.Performer2
