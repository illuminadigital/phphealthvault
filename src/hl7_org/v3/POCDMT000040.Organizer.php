 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Organizer")
 */
class POCDMT000040.Organizer {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.Component4", collection="true", name="component")
	 */
	protected $component;
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $id = NULL, $code = NULL, $statusCode = NULL, $effectiveTime = NULL, $subject = NULL, $specimen = NULL, $performer = NULL, $author = NULL, $informant = NULL, $participant = NULL, $reference = NULL, $precondition = NULL, $component = NULL, $nullFlavor = NULL, $classCode = NULL, $moodCode = NULL) {
	...
	protected function validateComponent($component) {
		if ( ! $component instanceof \hl7_org\v3\POCDMT000040.Component4  && ! is_null($component) ) {
			$component = new \hl7_org\v3\POCDMT000040.Component4 ($component);
		}
		...
		foreach ($component as $entry) {
			if (!($entry instanceof POCDMT000040.Component4)) {
				throw new \Exception(sprintf('Supplied %s value was not %s', 'component', 'POCD_MT000040.Component4'));
			}
		}
	...
	protected function createClassCode() {
		return new \hl7_org\v3\XActClassDocumentEntryOrganizer();
	}
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\XActClassDocumentEntryOrganizer ) {
			$classCode = new \hl7_org\v3\XActClassDocumentEntryOrganizer ($classCode);
		}
...
} // end class POCDMT000040.Organizer
