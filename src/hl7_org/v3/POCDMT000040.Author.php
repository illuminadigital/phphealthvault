...
class POCDMT000040.Author {
	...
	/**
	 * @XmlElement	(type="\hl7_org\v3\POCDMT000040.AssignedAuthor", name="assignedAuthor")
	 */
	...
	protected function createAssignedAuthor() {
		return new \hl7_org\v3\POCDMT000040.AssignedAuthor();
	}
	...
	protected function validateAssignedAuthor($assignedAuthor) {
		if ( ! $assignedAuthor instanceof \hl7_org\v3\POCDMT000040.AssignedAuthor ) {
			$assignedAuthor = new \hl7_org\v3\POCDMT000040.AssignedAuthor ($assignedAuthor);
		}
