 ...
 */
class IVLREAL extends \org\w3\www\_2001\XMLSchema\SXCMREAL {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\IVXBREAL", name="low")
	 */
	protected $low;

	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\REAL", name="width")
	 */
	protected $width;

	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\IVXBREAL", name="high")
	 */
	protected $high;

	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\REAL", name="center")
	 */
	protected $center;
