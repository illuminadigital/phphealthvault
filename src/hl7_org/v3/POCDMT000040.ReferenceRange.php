...
class POCDMT000040.ReferenceRange {
	...
	/**
	 * @XmlElement	(type="\org\w3\www\_2001\XMLSchema\POCDMT000040.ObservationRange", name="observationRange")
	 */
	...
	public function getObservationRange($autoCreate = TRUE) {
		if ($this->observationRange===NULL && $autoCreate && ! isset($this->_overrides['observationRange']) ) {
