 ...
 * })
 * @XmlEntity	(xml="POCD_MT000040.Entity")
 */
class POCDMT000040.Entity {
	/**
	 */
	...
	public function __construct($realmCode = NULL, $typeId = NULL, $templateId = NULL, $id = NULL, $code = NULL, $desc = NULL, $nullFlavor = NULL, $classCode = NULL, $determinerCode = NULL) {
	...
	protected function createClassCode() {
		return new \hl7_org\v3\EntityClassRoot();
	}
	...
	protected function validateClassCode($classCode) {
		if ( ! $classCode instanceof \hl7_org\v3\EntityClassRoot  && ! is_null($classCode) ) {
			$classCode = new \hl7_org\v3\EntityClassRoot ($classCode);
		}
