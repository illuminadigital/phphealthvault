...
class ExitStatus {
	...
	/**
	 * @XmlElement	(type="\org\sifinfo\www\infrastructure\_2_x\NCES0643ExitWithdrawalStatusType", name="Code")
	 */
	protected $code;
	...
	protected function createCode() {
		return new \org\sifinfo\www\infrastructure\_2_x\NCES0643ExitWithdrawalStatusType();
	}
	...
	protected function validateCode($code) {
		if ( ! $code instanceof \org\sifinfo\www\infrastructure\_2_x\NCES0643ExitWithdrawalStatusType ) {
			$code = new \org\sifinfo\www\infrastructure\_2_x\NCES0643ExitWithdrawalStatusType ($code);
		}
