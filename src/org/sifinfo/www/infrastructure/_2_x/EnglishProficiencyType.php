 ...
 * })
 * @XmlEntity	(xml="EnglishProficiencyType")
 */
class EnglishProficiencyType {
	/**
	 */

	/**
	 * @XmlElement	(type="\org\sifinfo\www\infrastructure\_2_x\NCES0585EnglishProficiencyType", name="Code")
	 */
	protected $code;
...
} // end class EnglishProficiencyType
