 ...
 * })
 * @XmlRootEntity	(xml="NCES0849RaceType")
 */
class NCES0849RaceType {
	/**
	 */
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'NCES0849RaceType', $value));
		}
