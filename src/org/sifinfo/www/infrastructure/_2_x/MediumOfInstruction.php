 ...
 * })
 * @XmlEntity	(xml="MediumOfInstruction")
 */
class MediumOfInstruction {
	...
	/**
	 * @XmlElement	(type="\org\sifinfo\www\infrastructure\_2_x\NCES0209MediumOfInstructionType", name="Code")
	 */
	protected $code;
