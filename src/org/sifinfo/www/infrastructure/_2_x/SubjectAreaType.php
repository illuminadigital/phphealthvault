 ...
 * })
 * @XmlEntity	(xml="SubjectAreaType")
 */
class SubjectAreaType {
	/**
	 * This is a common element used to designate the subject area of a course or other learning materials, or a department. It is used inSchoolCourseInfo and learning-related objects.
	 */
