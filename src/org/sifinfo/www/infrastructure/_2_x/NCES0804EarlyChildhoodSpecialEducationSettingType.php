 ...
 * })
 * @XmlRootEntity	(xml="NCES0804EarlyChildhoodSpecialEducationSettingType")
 */
class NCES0804EarlyChildhoodSpecialEducationSettingType {
	/**
	 */
	...
	/**
	 * @XmlValue	(type="string", name="NCES0804EarlyChildhoodSpecialEducationSettingType")
	 */
	protected $value;
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'NCES0804EarlyChildhoodSpecialEducationSettingType', $value));
		}
...
} // end class NCES0804EarlyChildhoodSpecialEducationSettingType
