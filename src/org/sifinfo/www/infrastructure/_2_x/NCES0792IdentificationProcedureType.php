 ...
 * })
 * @XmlRootEntity	(xml="NCES0792IdentificationProcedureType")
 */
class NCES0792IdentificationProcedureType {
	/**
	 */
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'NCES0792IdentificationProcedureType', $value));
		}
...
} // end class NCES0792IdentificationProcedureType
