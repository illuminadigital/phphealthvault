 ...
 * })
 * @XmlRootEntity	(xml="NCES1050PerpetratorDescriptionType")
 */
class NCES1050PerpetratorDescriptionType {
	/**
	 */
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'NCES1050PerpetratorDescriptionType', $value));
		}
...
} // end class NCES1050PerpetratorDescriptionType
