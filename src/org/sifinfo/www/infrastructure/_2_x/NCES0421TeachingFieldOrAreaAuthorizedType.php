...
class NCES0421TeachingFieldOrAreaAuthorizedType {
	...
	/**
	 * @XmlValue	(type="string", name="NCES0421TeachingFieldOrAreaAuthorizedType")
	 */
	protected $value;
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'NCES0421TeachingFieldOrAreaAuthorizedType', $value));
		}
...
} // end class NCES0421TeachingFieldOrAreaAuthorizedType
