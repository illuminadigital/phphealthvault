...
use com\microsoft\wc\subscription\String128;
...
class OpenQueryInfo {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\Guid", name="query-id")
	 */
	protected $queryId;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\String255", name="app-name")
	 */
	protected $appName;
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\subscription\String128", name="note")
	 */
	protected $note;
