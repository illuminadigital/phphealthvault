...
use com\microsoft\wc\application\CultureSpecificExtensionItem;
...
class CultureSpecificExtensionItems {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\CultureSpecificExtensionItem", collection="true", name="extension-item")
	 */
