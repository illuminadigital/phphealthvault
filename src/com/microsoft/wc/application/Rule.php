...
use com\microsoft\wc\application\String16;
use com\microsoft\wc\application\CultureSpecificString1024;
use com\microsoft\wc\application\Permission;
use com\microsoft\wc\application\Set;
...
class Rule {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\CultureSpecificString1024", collection="true", name="reason")
	 */
	protected $reason;
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Permission", collection="true", name="permission")
	 */
	protected $permission;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Set", collection="true", name="target-set")
	 */
	protected $targetSet;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Set", collection="true", name="exception-set")
	 */
