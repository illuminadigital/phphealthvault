...
class VocabularyKey {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Stringnz", name="name")
	 */
	protected $name;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Stringnz", name="family")
	 */
	protected $family;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\Stringnz", name="version")
	 */
	protected $version;
