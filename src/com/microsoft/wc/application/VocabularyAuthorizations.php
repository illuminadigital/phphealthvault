...
use com\microsoft\wc\application\VocabularyAuthorization;
...
class VocabularyAuthorizations {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\application\VocabularyAuthorization", collection="true", name="vocabulary-authorization")
	 */
