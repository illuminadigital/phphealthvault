...
class Address {
	 ...
	 * An address may be used for either a mailing address orphysical location.
	 */
	...
	public function __construct($description = NULL, $isPrimary = NULL, $street = NULL, $city = NULL, $state = NULL, $postcode = NULL, $country = NULL, $county = NULL) {
