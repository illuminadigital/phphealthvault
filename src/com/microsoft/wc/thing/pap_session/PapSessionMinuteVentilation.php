 ...
 * })
 * @XmlEntity	(xml="pap-session-minute-ventilation")
 */
class PapSessionMinuteVentilation {
	/**
	 */
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\VolumeValue", name="median")
	 */
	protected $median;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\VolumeValue", name="maximum")
	 */
	protected $maximum;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\VolumeValue", name="percentile-95th")
	 */
	protected $percentile95th;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\VolumeValue", name="percentile-90th")
	 */
...
} // end class PapSessionMinuteVentilation
