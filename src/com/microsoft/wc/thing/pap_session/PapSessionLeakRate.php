 ...
 * })
 * @XmlEntity	(xml="pap-session-leak-rate")
 */
class PapSessionLeakRate {
	/**
	 */

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\FlowValue", name="mean")
	 */
	protected $mean;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\FlowValue", name="median")
	 */
	protected $median;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\FlowValue", name="maximum")
	 */
	protected $maximum;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\FlowValue", name="percentile-95th")
	 */
	protected $percentile95th;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\types\FlowValue", name="percentile-90th")
	 */
	...
	protected function validateMean($mean) {
		if ( ! $mean instanceof \com\microsoft\wc\thing\types\FlowValue  && ! is_null($mean) ) {
			$mean = new \com\microsoft\wc\thing\types\FlowValue ($mean);
		}
	...
	protected function validateMedian($median) {
		if ( ! $median instanceof \com\microsoft\wc\thing\types\FlowValue  && ! is_null($median) ) {
			$median = new \com\microsoft\wc\thing\types\FlowValue ($median);
		}
	...
	protected function validateMaximum($maximum) {
		if ( ! $maximum instanceof \com\microsoft\wc\thing\types\FlowValue  && ! is_null($maximum) ) {
			$maximum = new \com\microsoft\wc\thing\types\FlowValue ($maximum);
		}
	...
	protected function validatePercentile95th($percentile95th) {
		if ( ! $percentile95th instanceof \com\microsoft\wc\thing\types\FlowValue  && ! is_null($percentile95th) ) {
			$percentile95th = new \com\microsoft\wc\thing\types\FlowValue ($percentile95th);
		}
	...
	protected function validatePercentile90th($percentile90th) {
		if ( ! $percentile90th instanceof \com\microsoft\wc\thing\types\FlowValue  && ! is_null($percentile90th) ) {
			$percentile90th = new \com\microsoft\wc\thing\types\FlowValue ($percentile90th);
		}
	
		return $percentile90th;
	}
} // end class PapSessionLeakRate
