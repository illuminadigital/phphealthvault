...
use com\microsoft\wc\thing\Iso3166;
...
class Culture {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Iso6391", name="language")
	 */
	protected $language;

	/**
	 * @XmlElement	(type="\com\microsoft\wc\thing\Iso3166", name="country")
	 */
	protected $country;
