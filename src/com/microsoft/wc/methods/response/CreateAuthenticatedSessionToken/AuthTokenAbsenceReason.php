...
/**
 * @XmlRootEntity	(xml="AuthTokenAbsenceReason")
 */
class AuthTokenAbsenceReason {
	/**
	 */
	...
	protected function validateValue($value) {
		...
		if (empty(static::$enumValue[$value])) {
			throw new \Exception(sprintf('Supplied %s value (%s) was not a valid enumerated value.', 'AuthTokenAbsenceReason', $value));
		}
...
} // end class AuthTokenAbsenceReason
