...
class Info extends \com\microsoft\wc\request\Info {
	...
	/**
	 * @XmlElement	(type="\com\microsoft\wc\methods\GetThings3\ThingRequestGroup2", collection="true", name="group")
	 */
	protected $group;
	...
	protected function validateGroup($group) {
		if ( ! $group instanceof \com\microsoft\wc\methods\GetThings3\ThingRequestGroup2 ) {
			$group = new \com\microsoft\wc\methods\GetThings3\ThingRequestGroup2 ($group);
		}
		$count = count($group);
		if ($count < 1) {
